...
\item \textbf{ETHRome 2024} - won various prizes for a dapp using zero-knowledge proofs based app (\uhref{https://aztec.network/}{Aztec network} and \uhref{https://noir-lang.org/}{Noir}, a language for SNARK proofs)
